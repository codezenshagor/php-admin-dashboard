...
<li>
<div class="media">
<img class="img-radius" src="<?=$urls?>views/admin/assets/jpg/avatar-4.jpg" alt="Generic placeholder image">
...
<li>
<div class="media">
<img class="img-radius" src="<?=$urls?>views/admin/assets/jpg/avatar-3.jpg" alt="Generic placeholder image">
<div class="media-body">
...
<div class="dropdown-primary dropdown">
<div class="dropdown-toggle" data-toggle="dropdown">
<img src="<?=$urls?>views/admin/assets/jpg/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
<span>John Doe</span>
...
<img class="media-object img-radius img-radius" src="<?=$urls?>views/admin/assets/jpg/avatar-3.jpg" alt="Generic placeholder image ">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="<?=$urls?>views/admin/assets/jpg/avatar-2.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="<?=$urls?>views/admin/assets/jpg/avatar-4.jpg" alt="Generic placeholder image">
<div class="live-status bg-success"></div>
</a>
<div class="media-body">
...
<a class="media-left" href="#!">
<img class="media-object img-radius" src="<?=$urls?>views/admin/assets/jpg/avatar-3.jpg" alt="Generic placeholder image">
...
<img class="media-object img-radius img-radius m-t-5" src="<?=$urls?>views/admin/assets/jpg/avatar-2.jpg" alt="Generic placeholder image">
</a>
      ...
      <ul class="pcoded-item pcoded-left-item">
        ...
        <li class="pcoded-hasmenu active pcoded-trigger">
          ...
          <ul class="pcoded-submenu">
            <li>
              <a href="/admin/hr-overview" class="waves-effect waves-dark">
